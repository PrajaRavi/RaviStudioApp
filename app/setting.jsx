...
const setting = () => {
  const {IconSize,setIconSize}=useContext(AppContext)
...
<TouchableOpacity style={{display:'flex',flexDirection:'row',alignItems:'center',justifyContent:'center',gap:10,marginTop:0,    backgroundColor: 'rgba(255, 255, 255, 0.2)',
